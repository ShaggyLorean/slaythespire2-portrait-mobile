...
> Inherited launcher-overhaul research. Package names, APK names, release tags, and device results below describe the upstream base, not the `StS2 Portrait` integration.

...
| Karakter seçim | ⚠️ İşlevsel | bilgi paneli ("The Ironclad") sol taşıyor — düzeltilecek |
...
## 🔜 Kalan
- Karakter seçim bilgi paneli taşması
- Dükkan sağ-kenar kartları
- Görülmeyen ekranlar: event, dinlenme (rest), hazine (treasure), ayarlar (settings/UI scale), kart seçim overlay'leri

...
// SteamKitAndroidPatch rewrites call sites in SteamKit2.dll to these methods.
// They must therefore remain public: the calls cross an assembly boundary at runtime.
public static class AndroidJavaCrypto
{

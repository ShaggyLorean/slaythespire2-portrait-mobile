...
{
    private const string ExternalStorageRoot = "/storage/emulated/0/StS2Portrait";
    ...
    internal const string ExternalOfflineImportDir = ExternalStorageRoot + "/Offline";
    ...
    internal static void EnsureExternalDirectories()
    {
        ...
        EnsureExternalDirectory(ExternalOfflineImportDir);

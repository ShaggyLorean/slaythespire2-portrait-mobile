...
internal static class PlatformPatches
{
    ...
    {
        PatchPlatformUtilMethod(harmony, GetPlatformBranch, nameof(ReturnNoPlatformBranchPrefix));
    ...
    private static bool ReturnNoPlatformBranchPrefix(ref PlatformBranch __result)
    {
        __result = PlatformBranch.None;
        return false;
    }

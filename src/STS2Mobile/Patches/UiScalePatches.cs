...
internal static class UiScalePatches
{
    ...
    {
        // The desktop scale selector used a landscape 1680x1080 design canvas.
        // Applying that on Android after the game PCK starts is what produced the
        // tiny, stretched horizontal game strip. PortraitDisplay also preserves
        // the selected UI magnification through its own virtual short edge.
